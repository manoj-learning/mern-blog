        ...
        <div className="post-content">
          <div className="post-social">
            ...
            <ul className="share-post">
              <li>
                <a href="_#" className="facebook">
                  <i className="fa fa-facebook"></i>
                </a>
              </li>
              <li>
                <a href="_#" className="twitter">
                  <i className="fa fa-twitter"></i>
                </a>
              </li>
              <li>
                <a href="_#" className="pinterest">
          ...
          <div className="post-content-text">
            <p>
              ...
              ligula <a href="_#">sollicitudin laoreet viverra</a>, tortor
            ...
            <p>
              ...
              <a href="_#">elementum hendrerit </a> tortor. Sed semper lorem at
            ...
            <p>
              ...
              dui, eu <a href="_#">pulvinar nunc sapien</a> ornare nisl.
            ...
            <p>
              ...
              <a href="_#">adipiscing varius </a>, adipiscing in, lacinia vel,
            ...
            <div className="share-tags-box">
              <ul className="tags">
                ...
                <li>
                  <a href="_#">adventure</a>
                </li>
                <li>
                  <a href="_#">lifestyle</a>
                </li>
              </ul>
              <ul className="shares-likes">
                <li>
                  <a href="_#" className="likes">
